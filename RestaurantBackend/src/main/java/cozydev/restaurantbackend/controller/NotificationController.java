...
public class NotificationController {
    ...
    @GetMapping("/notif/{userId1}")
    public List<Notifcation> getNotificationsByUserId(@PathVariable Long userId1){
        return this.notificationService.getNotificationsByUserId(userId1);
    }
